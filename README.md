...
Переопределите метод toString. (Возврат строки: «Привет! Меня зовут name, мне age лет (/год/года), я вешу - weight кг,
мой цвет - color») лет или год, или года должно быть выбрано в зависимости от числа.
...
- использовать абстрактные классы
  Рекомендуем сдать до: 16.12.2025
- 
- Правки:
  06.12.2025 из gitignor убраны исключения для скомпилированных файлов внутри дирректории 
- (src: !/src/main//out/ и !/src/test//out/)
- 
- 07.12.2025:
- изменено имя константы NAME на COMMAND для поддержания корректности преемственности нейминга;
- добавлен цикл в запрос имени животного на случай пустого ввода;
- в метод setName() добавлена обработка имени, при которой кличка будет начинаться с заглавной буквы, при любом способе ввода
- добавлен цикл в запрос возраста животного на случай пустого ввода, ввода символов или отрицательного значения;
- добавлен цикл в запрос веса животного на случай пустого ввода, ввода символов или отрицательного значения.